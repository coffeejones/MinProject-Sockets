...
## JavaFX afprøvet 17. september 2026
...
| --- | --- | --- |---|
| 1 | Start server og tre klienter: alice, bob, charlie. | Alle kan sende og modtage samtidig i lobby. | Bekræftet |
| 2 | Forsøg login som bob fra en ekstra klient, derefter som dana. | bob afvises; dana accepteres på samme forbindelse. | Bekræftet |
| 3 | Flyt charlie til java og send i begge rum. | Kun medlemmer af det pågældende rum modtager nye beskeder. | Bekræftet |
| 4 | Send privat fra bob til charlie. | Kun charlie får privatteksten; bob får særskilt status. | Bekræftet |
| 5 | Send privat til en offlinebruger og skift til et ukendt rum. | Tydelig fejl; forbindelsen og gammelt medlemskab bevares. | Bekræftet |
| 6 | Send en fejlformateret linje og derefter en gyldig. | Fejl efterfulgt af normalt svar på samme forbindelse. | Bekræftet |
| 7 | Afslut bob med quit og stop charlies proces uventet. | Begge navne kan bruges igen; gamle medlemskaber fjernes. | Bekræftet |
| 8 | Brug både JavaFX og konsol samtidig. | Samme rum, privatbeskeder og fejl virker på tværs af klienttyper. | Bekræftet |
| 9 | Stop serveren mens klienterne venter på input. | Klienterne melder afbrudt forbindelse og frigiver ressourcer. | Bekræftet |
| 10 | Luk JavaFX-vinduet og prøv forbindelse til en utilgængelig server. | Proces afslutter, og nyt forbindelsesforsøg viser en forståelig fejl uden frosset GUI. | Bekræftet |
